"use strict";(()=>{var e={};e.id=1631,e.ids=[1631],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},52898:(e,t,n)=>{n.r(t),n.d(t,{originalPathname:()=>f,patchFetch:()=>h,requestAsyncStorage:()=>m,routeModule:()=>p,serverHooks:()=>g,staticGenerationAsyncStorage:()=>d});var o={};n.r(o),n.d(o,{POST:()=>u,dynamic:()=>l});var r=n(49303),i=n(88716),a=n(60670),s=n(87070),c=n(26729);let l="force-dynamic";async function u(e){try{let{attendanceData:t,timeRange:n}=await e.json();if(!t||!Array.isArray(t))return s.NextResponse.json({error:"attendanceData array is required"},{status:400});if(!n)return s.NextResponse.json({error:"timeRange is required"},{status:400});let o=await (0,c.Rt)(t,n);if(!o.success)return s.NextResponse.json({error:o.error},{status:500});return s.NextResponse.json({insights:o.data})}catch(e){return s.NextResponse.json({error:e instanceof Error?e.message:"Unknown error"},{status:500})}}let p=new r.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/ai/insights/route",pathname:"/api/ai/insights",filename:"route",bundlePath:"app/api/ai/insights/route"},resolvedPagePath:"/Users/rishiraj/Downloads/checkin-main/app/api/ai/insights/route.ts",nextConfigOutput:"",userland:o}),{requestAsyncStorage:m,staticGenerationAsyncStorage:d,serverHooks:g}=p,f="/api/ai/insights/route";function h(){return(0,a.patchFetch)({serverHooks:g,staticGenerationAsyncStorage:d})}},26729:(e,t,n)=>{n.d(t,{E5:()=>a,Rt:()=>i,hn:()=>r,ib:()=>c,xg:()=>s});let o=process.env.OPENROUTER_API_KEY||"";async function r(e,t=.7){if(!o)return console.error("OpenRouter API key not configured"),{success:!1,error:"OpenRouter API key not configured"};for(let n of["moonshotai/kimi-k2:free","google/gemma-3n-e4b-it:free","meta-llama/llama-3.2-3b-instruct:free","microsoft/phi-3-mini-128k-instruct:free"]){console.log(`Trying model: ${n}`);for(let r=1;r<=2;r++)try{let r=new AbortController,i=setTimeout(()=>r.abort(),3e4),a=await fetch("https://openrouter.ai/api/v1/chat/completions",{method:"POST",headers:{Authorization:`Bearer ${o}`,"Content-Type":"application/json","HTTP-Referer":"https://talkxo-checkin.vercel.app","X-Title":"INSYDE AI"},body:JSON.stringify({model:n,messages:e,temperature:t,max_tokens:1200}),signal:r.signal});if(clearTimeout(i),429===a.status){console.log(`Rate limited on ${n}, trying next model...`);break}if(!a.ok){let e=await a.text();if(console.error(`❌ Model ${n} failed: ${a.status} - ${e}`),401===a.status)return console.error("Authentication error - API key might be invalid"),{success:!1,error:"Authentication failed - check API key"};break}let s=await a.json();return console.log(`✅ Success with model: ${n}`),console.log(`Response length: ${s.choices[0]?.message?.content?.length||0} characters`),{success:!0,data:s.choices[0]?.message?.content||""}}catch(i){console.log(`Model ${n} error (attempt ${r}):`,i);let e="undefined"!=typeof DOMException&&i instanceof DOMException&&"AbortError"===i.name,t=i instanceof Error&&"string"==typeof i.message&&i.message.includes("timeout");if(e||t){console.log(`Timeout on ${n}, trying next model...`);break}if(2===r)break;let o=1e3*Math.pow(2,r-1);await new Promise(e=>setTimeout(e,o))}}return{success:!1,error:"All models failed or rate limited"}}async function i(e,t){return r([{role:"system",content:"You are an HR analyst. Provide concise, actionable insights in Markdown format. Focus on key patterns and recommendations."},{role:"user",content:`Analyze attendance data for ${t}. Format response in Markdown with clear sections:
...
Example: "Did you know? Taking short breaks every 90 minutes can boost productivity by 20%. Your consistent check-ins show great discipline!"`}],.1)}}};var t=require("../../../../webpack-runtime.js");t.C(e);var n=e=>t(t.s=e),o=t.X(0,[8948,5972],()=>n(52898));module.exports=o})();