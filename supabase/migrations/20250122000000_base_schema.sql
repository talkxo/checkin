-- Base schema: employees, sessions, settings, and core indexes/RLS
-- Run BEFORE settings and pin migrations
...
-- Function to get today's sessions for admin dashboard
